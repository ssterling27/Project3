...
const Parralax = () => {
  ...
  return(
    <>
      <div style={{ transform: `translateY(${offset1}px)`, position: 'absolute', zIndex: '1', marginTop: '-14vh', overflow: 'hidden', opacity: `${opacity1}`, width: '100%', display: 'flex', justifyContent: 'center'}}>
      <img src={sunVector} style={{width: '50vw', minWidth: '500px'}} alt={'sun'}></img>
    </div>
      <div style={{ transform: `translateY(${offset2}px)`, position: 'absolute', zIndex: '1', marginTop: '-14vh', overflow: 'hidden', opacity: `${opacity2}`, width: '100%', display: 'flex', justifyContent: 'center'}}>
      <img src={sunVector2} style={{width: '50vw', minWidth: '500px'}} alt={'sun'}></img>
    </div>
      <div style={{ transform: `translateY(${offset3}px)`, position: 'absolute', zIndex: '1', marginTop: '-14vh', overflow: 'hidden', opacity: `${opacity3}`, width: '100%', display: 'flex', justifyContent: 'center' }}>
        <img src={sunVector3} style={{ width: '50vw', minWidth: '500px' }} alt={'sun'}></img>
      </div>
      <div style={{ transform: `translateY(${offset4}px)`, position: 'absolute', zIndex: '1', marginTop: '-14vh', overflow: 'hidden', opacity: `${opacity4}`, width: '100%', display: 'flex', justifyContent: 'center' }}>
